...
def PrintMenu():
	...
	print('\n1 - Select A Vocabulary \n2 - Manually Add A Word To The Vocabulary \n3 - Add Words To The Vocabulary With A File \n4 - Start The Test With Random Words \n5 - Create A New Vocabulary\n6 - Exit')
	print() # Empty Line
...
def AutoAddNewWords():
    ...
    # Tk
    root = Tk()
    root.title('Select Vocabulary File')
...
while True:
    ...
    if command == '1':
        SelectDatabase(input('Vocabulary name: '))
    elif command == '2':
        AddNewWords()
    elif command == '3':
        AutoAddNewWords()
        ...
        CreateDatabase(input('Vocabulary Name: '))
    elif command == '6':
